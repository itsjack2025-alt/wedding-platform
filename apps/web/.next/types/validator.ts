...
// Validate ../../src/app/api/blessings/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/blessings">> = Specific
  const handler = {} as typeof import("../../src/app/api/blessings/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
